...
<%
	...
	int count = gdao.getAllBest();
	ArrayList<GameBean> lists2 = gdao.getAllByBest(startRow,endRow); 
%>  
<br>
<div align="left" style="margin-left: 100px;">
 <font size="5px">인기상품</font>
</div>
<hr width="800">
<table width="800">
<tr>
...
<%
	if(count > 0){
		...
		if(startPage>10){
		%>
			<a href="mall_best.jsp?pageNum=<%=startPage-10 %>">이전</a>
		<%		
		}
		for(int i=startPage;i<=endPage;i++){
		%>
			<a href="mall_best.jsp?pageNum=<%=i %>"><%=i %></a>
		<%
		}
		if(endPage<pageCount){
		%>
			<a href="mall_best.jsp?pageNum=<%=startPage+10 %>">다음</a>
		<%
		}
	}
%>
