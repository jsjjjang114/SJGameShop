...
<tr height="33" style="border-top:0.5px solid black;">
 ...
 <td align="left" rowspan="2" width="110">
  <img width="<%=bb.getRe_level() * 20%>" height="30" src="../img/white.png">
  <img width="30" height="35" src="../img/pngwing.png">
 </td> 
 <td colspan="2" align="center">
  <a href="content.jsp?num=<%=bb.getNum()%>">
   <%=bb.getSubject() %>
...
<%
 ...
 <tr style="border-top:0.5px solid black;">
  <td colspan="5">
  <button class="btn-two blue mini" onclick="review('<%=userid%>')">리뷰등록</button></td>
 </tr>	
 <tr>
