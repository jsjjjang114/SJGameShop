...
<form action="updateForm.jsp?num=<%=num%>" method="post">
<table border="1" width="100%">
 ...
 <tr>
  <td align="right">
   <button class="btn-two blue mini">수정하기</button>
   <button type="button" class="btn-two blue mini" onclick="deleteReview('<%=num%>')">삭제하기</button>
  </td>
 </tr>
</table>
</form>
